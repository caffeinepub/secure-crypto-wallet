...
export class Backend implements backendInterface {
    ...
    async getAutoLockTimeout(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getAutoLockTimeout();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getBiometricsEnabled(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.getBiometricsEnabled();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasWallet(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasWallet();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setAutoLockTimeout(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setAutoLockTimeout(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setBiometricsEnabled(arg0: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setBiometricsEnabled(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setWalletSetup(arg0: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setWalletSetup(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
